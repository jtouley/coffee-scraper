...
if 'products' in main_page_result:
    products_info = [{'Name': item['Name'], 'URL': base_product_url + item['Name'].replace(" ", "-")} for item in main_page_result['products']]
    ...
    print("No products found on the main page.")
